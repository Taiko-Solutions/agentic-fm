    ...
    def _handle_explode(self):
        ...
        try:
            ...
            permission_block = (
                ...
                and ("getcwd" in stderr_text or "fmparse.sh" in stderr_text)
            )
            hint = (
                "macOS bloqueó el acceso al repo desde el proceso launchd. "
                "Prueba moviendo el repo fuera de Documents o concede Full Disk Access al ejecutable Python usado por el LaunchAgent, "
                "y vuelve a reiniciar los servicios."
